...
def main():
    """
    A simple 'Guess My Number' game where the user tries to guess a randomly chosen 
    number between 1 and 99, with feedback on whether their guess is too high or too low.
    """
    ...
    while True:
        try:
            ...
            print("⚠️ Invalid input. Please enter a valid number between 1 and 99.")
